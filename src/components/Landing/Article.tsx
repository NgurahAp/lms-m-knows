      ...
      <div className="container mx-auto flex flex-col items-center justify-center">
        <div className="flex flex-wrap mx-auto justify-center gap-5">
          {sekilasIlmuCards.map((card) => (
            <div className="md:w-96 md:mx-0 mx-3 bg-white border border-gray-200 rounded-lg shadow ">
              <a href="#">
                <img
              ...
              <div className="px-5 py-5 md:text-base text-sm  flex items-end">
                <a href="#" className="w-full">
                  ...
                  <h5 className="mb-2 md:text-2xl text-lg min-h-14 font-bold tracking-tight ">
                    {card.title}
                  </h5>
                  <p className=" text-[#737373]">{card.description}</p>
                  <div className="flex justify-between pb-3 items-center md:pt-10 pt-5">
                    <p className="text-sm md:text-base text-[#737373]">{card.views}</p>
