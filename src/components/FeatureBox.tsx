    ...
    >
      ...
      <div className="w-full bg-white h-56 flex flex-col justify-center">
        <div className="grid grid-cols-3 gap-4 items-center mb-4">
          ...
          <Link to="/bootcamp" className="flex flex-col items-center">
        ...
        <div className="flex justify-center gap-8">
          <Link to="/pelatihanku" className="flex flex-col items-center">
          ...
          <Link to="/nilai-sertifikat" className="flex flex-col items-center">
      ...
      <button className="py-4 w-full bg-blue-300 rounded-b-lg">
        Lihat Semua
      </button>
    </div>
  );
