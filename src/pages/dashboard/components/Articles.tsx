  ...
  return (
    <div className="relative z-2 mt-6 p-6 w-full h-auto bg-white shadow-md rounded-lg">
      <div className="flex justify-between items-center mb-10">
        <h2 className="text-2xl font-semibold">Sekilas Ilmu</h2>
        <a href="/sekilas-ilmu" className="text-blue-500 text-sm">
          Lihat Semua
        </a>
      </div>
              ...
              <div key={article.id} className="w-full flex-shrink-0">
                <div className="shadow-md border-2 pb-5 mx-2">
                  ...
                  <div className="min-h-20">
                    <h3 className="text-xl font-semibold my-2 px-4">
                  ...
                  <div className="px-4 flex justify-between">
                    <div>
                      <p className="text-lg">{article.author.full_name}</p>
