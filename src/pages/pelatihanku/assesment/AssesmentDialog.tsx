interface AssesmentDialogProps {
  onClose: () => void;
  onSubmit: () => void;
}

export const AssesmentDialog = ({ onClose, onSubmit }: AssesmentDialogProps) => {
  return (
    <div className="fixed inset-0 flex items-center justify-center bg-black bg-opacity-50 z-50">
      <div className="bg-white p-6 rounded-lg shadow-lg h-64 flex flex-col justify-center w-[30rem]">
        <h2 className="text-xl font-semibold text-center mb-2 mx-5">
          Apakah Anda yakin Ingin Submit <br /> Penilaian Pengajar ?
        </h2>
        <div className="border-b-2 border-blue-500 mx-auto w-20 mb-4"></div>

        <p className="text-center text-gray-600 mb-6">
          Cek kembali jawaban anda dengan benar!
        </p>
